...
system/src/newlib/startup.o: ../system/src/newlib/startup.c system/src/newlib/subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: GNU Arm Cross C Compiler'
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -Wall -Wextra -g -DNDEBUG -DSTM32F401xE -DUSE_HAL_DRIVER -DHSE_VALUE=8000000 -DOS_INCLUDE_STARTUP_INIT_MULTIPLE_RAM_SECTIONS -I"../include" -I"D:\SBME\3rd Year\Embedded\Vehicle_Door_Handle-_Control_Unit\Final_Project\Gpio" -I"D:\SBME\3rd Year\Embedded\Vehicle_Door_Handle-_Control_Unit\Final_Project\GPT" -I"D:\SBME\3rd Year\Embedded\Vehicle_Door_Handle-_Control_Unit\Final_Project\Rcc" -I"D:\SBME\3rd Year\Embedded\Vehicle_Door_Handle-_Control_Unit\Final_Project\Lib" -I"../system/include" -I"../system/include/cmsis" -I"../system/include/stm32f4-hal" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
